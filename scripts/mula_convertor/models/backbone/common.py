...
class GhostBottleneck(nn.Module):
    def __init__(self, c1, c2, k=3, s=1, act=True):
        super().__init__()
        c_ = c2 // 2
        self.conv = nn.Sequential(GhostConv(c1, c_, 1, 1, act=act),
...
class ELAN(nn.Module):
    def __init__(self, c1, c2, n=1, e=0.5, with_mp=True, with_aug=True, act=True):
        super().__init__()
        c_ = int(c1 * e)
...
class ELAN_NECK(nn.Module):
    def __init__(self, c1, c2, n=1, e=0.5, e_m=0.5, act=True):
        super().__init__()
        c_ = int(c1 * e)
        c_m = int(c_ * e_m)
