...
class YoloV7Neck(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.c_0 = int(self.input_p5/2)
        self.c_1 = int(self.input_p5/4)
        self.c_2 = int(self.input_p5/8)
        self.c_3 = int(self.input_p5/16)
        ...
        self.conv10 = Conv(self.c_1, self.c_2, 1, 1, None, 1, CONV_ACT)
        self.upsample2 = nn.Upsample(scale_factor=2, mode="nearest")

        self.conv11 = Conv(self.c_0, self.c_2, 1, 1, None, 1, CONV_ACT)

        self.elan_1 = ELAN_NECK(self.c_1, self.c_2, 3, 0.5, 0.5, CONV_ACT)

        self.conv19 = Conv(self.c_2, self.c_2, 1, 1, None, 1, CONV_ACT)
        self.conv20 = Conv(self.c_2, self.c_2, 1, 1, None, 1, CONV_ACT)
        self.conv21 = Conv(self.c_2, self.c_2, 3, 2, None, 1, CONV_ACT)

        self.elan_2 = ELAN_NECK(self.c_0, self.c_1, 3, 0.5, 0.5, CONV_ACT)

        self.conv29 = Conv(self.c_1, self.c_1, 1, 1, None, 1, CONV_ACT)
        self.conv30 = Conv(self.c_1, self.c_1, 1, 1, None, 1, CONV_ACT)
        self.conv31 = Conv(self.c_1, self.c_1, 3, 2, None, 1, CONV_ACT)
